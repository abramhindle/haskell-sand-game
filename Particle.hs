...
data Particle = Dust Double Double Double Double | Wall Double Double deriving (Eq,Ord,Show)

radius_dust = 2.5 :: Double
radius_wall = 5.0 :: Double

radius (Dust _ _ _ _) = radius_dust
...
particleBoundaryPoints (Dust x y _ _) = particleBoundaryPointsGeneric radius_dust x y
...
particleBoundaryEdges (Dust x y _ _) = particleBoundaryEdgesGeneric radius_dust x y
...
particleBoundaryExtents (Dust x y _ _) = particleBoundaryExtentsGeneric radius_dust x y
...
particleBoundary (Dust x y _ _) = particleBoundaryGeneric radius_dust  x y
